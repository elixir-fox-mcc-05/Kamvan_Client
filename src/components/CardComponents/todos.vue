<template>
    <div class="card">
        <div class="card-header" style="background-color: orange;">
            <p class="title-card">To-do</p>
        </div>
        <div v-if="todos.Task">
            <div v-for="data in todos.Task" :key="data.id">
                <div class="card-body">
                ...
                <form action="" style="display:flex; flex-direction:column; justify-content:space-between">
                    <div style="height: 80%">
                        ...
                        <div style="display:flex; flex-direction:row">
                            ...
                            <button @click.prevent = "changeCategory" class="btn btn-primary btn-block">Doings</button>
...
export default {
    ...
    methods : {
        itemClicked: function(item) {
		    ...
		    this.$modal.show("detail-Modal-todos")
        },
        hide(){
            this.$modal.hide("detail-Modal-todos")
        },
        showConfirm(){
            this.$modal.show("confirm-todo")
        },
        hideConfirm(){
            this.$modal.hide("confirm-todo")
        },
        edit(){
            let payload = {
                id : this.id,
