<template>
    <div class="card">
        <div class="card-header" style="background-color: lightblue;">
            <p class="title-card">Doings</p>
        </div>
        <div v-if="doings.Task">
            <div v-for="data in doings.Task" :key="data.id">
                <div class="card-body">
                ...
                <form action="" style="display:flex; flex-direction:column; justify-content:space-between">
                    <div style="height: 80%">
                        ...
                        <div style="display:flex; flex-direction:row">
                            ...
                            <button @click.prevent = "changeCategory" class="btn btn-primary btn-block">Dones</button>
...
export default {
    ...
    methods : {
        itemClicked: function(item) {
		    ...
		    this.$modal.show("detail-Modal-doing")
        },
        hide(){
            this.$modal.hide("detail-Modal-doing")
        },
        showConfirm(){
            this.$modal.show("confirm-doing")
        },
        hideConfirm(){
            this.$modal.hide("confirm-doing")
        },
        edit(){
            let payload = {
                id : this.id,
